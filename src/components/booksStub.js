export default function booksStub() {
    return [
        {
            id: 101,
        ...
        },
        {
            ...
            description:
                'Оккультный роман, который впервые вышел в свет спустя почти 35 лет после смерти автора. Этот уникальный текст принадлежит перу К. Е. Антаровой, одной из тех самоотверженных русских женщин, чья жизнь была служением искусству и знанию.',
            price: 700,
            rest: 5,
            quantity: 1,
        },
        {
            ...
            description:
                'Серия книг, написанных Нилом Дональдом Уолшем. Она была написана как диалог, в котором Уолш задает вопросы, а Бог отвечает.',
            price: 1000,
            rest: 2,
            quantity: 1,
        },
        ...
        },
        {
            ...
            description:
                'Серия фантастических повестей о приключениях Сэра Макса, работника Тайного сыска в городе Ехо. «Лабиринты Ехо» написаны Светланой Мартынчик в соавторстве с Игорем Стёпиным и опубликованы под псевдонимом «Макс Фрай».',
            price: 400,
            rest: 8,
            quantity: 1,
        },
